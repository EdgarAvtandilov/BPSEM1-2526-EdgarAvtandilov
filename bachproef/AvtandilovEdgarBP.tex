...
\cosupervisor{Dhr. A. Reintjes}
\title[]%
    {Automatisatie van netwerkconfiguratie met Ansible: een proof-of-concept voor snellere, reproduceerbare en consistente, schaalbare en foutloze netwerkconfiguratie.}
...
% \begin{lstlisting}[caption={Cisco commando\'s voor basisopzet SSH}, label={lst:basis-ssh}]
%     configure terminal
%     hostname toestel
